...
{
	// Token: 0x060001EF RID: 495 RVA: 0x00003212 File Offset: 0x00001412
	private void Start()
	{
		this.FindScripts();
	}

	// Token: 0x060001F0 RID: 496 RVA: 0x00031480 File Offset: 0x0002F680
	...
	// Token: 0x060001F1 RID: 497 RVA: 0x000314F4 File Offset: 0x0002F6F4
	...
	// Token: 0x060001F2 RID: 498 RVA: 0x0000321A File Offset: 0x0000141A
	public bool IsErforscht(int i)
	{
		return this.RES_POINTS_LEFT[i] <= 0f;
	}

	// Token: 0x060001F3 RID: 499 RVA: 0x00031558 File Offset: 0x0002F758
	...
	// Token: 0x060001F4 RID: 500 RVA: 0x0000322E File Offset: 0x0000142E
	public int GetPrice(int i)
	{
		return this.RES_PRICE[i];
	}

	// Token: 0x060001F5 RID: 501 RVA: 0x00003238 File Offset: 0x00001438
	public Sprite GetPic(int i)
	{
		return this.RES_SPRITE[i];
	}

	// Token: 0x060001F6 RID: 502 RVA: 0x00003242 File Offset: 0x00001442
	public float GetProzent(int i)
	{
		return 100f / this.RES_POINTS[i] * (this.RES_POINTS[i] - this.RES_POINTS_LEFT[i]);
	}

	// Token: 0x060001F7 RID: 503 RVA: 0x00003264 File Offset: 0x00001464
	public bool ForschungGestartet(int i)
	{
		return this.RES_POINTS_LEFT[i] != this.RES_POINTS[i];
	}

	// Token: 0x060001F8 RID: 504 RVA: 0x0000327B File Offset: 0x0000147B
	...
	// Token: 0x060001F9 RID: 505 RVA: 0x00031958 File Offset: 0x0002FB58
	...
	// Token: 0x060001FA RID: 506 RVA: 0x000319E4 File Offset: 0x0002FBE4
